...
export enum CriticModeTextActionTypes {
  TOGGLE_CRITIC_MODE_TEXT_ACTION = '[CriticModeText] Toggle criticModeText Action',
...
export const toggleCriticModeTextAction = (): StoreAction<null> => {
  return {
    type: CriticModeTextActionTypes.TOGGLE_CRITIC_MODE_TEXT_ACTION,
    payload: null
  };
};
